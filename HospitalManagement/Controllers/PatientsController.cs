...
namespace HospitalManagement.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PatientId,Name,Age,Gender,ContactNumber,Address")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PatientId,Name,Age,Gender,ContactNumber,Address")] Patient patient)
        {
